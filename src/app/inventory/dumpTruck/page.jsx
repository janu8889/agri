...
export default function Agriculture() {
  ...
  const [filters, setFilters] = useState({ category: "dump" });
    ...
    <div className="max-w-screen-2xl mx-auto">
      ...
      <div className="relative w-full h-48 md:h-64 lg:h-80 overflow-hidden">
        ...
        <p className="mt-2 text-lg md:text-xl text-[#555] leading-relaxed">
            Discover our extensive selection of dump trucks, built to handle heavy loads, demanding jobs, and challenging environments with strength, efficiency, and reliability. Everything you need for construction, hauling, and material transport, designed to keep your operations moving with confidence.
        </p>
      </div>

      <FilterSection
        defaultCategory="dump"
        onFilter={handleFilter}
      />

      <CategorySeparator category="dump" />
