...
const initialForm = {
  ...
  tiresOrTracks: "",
  trackWidth: "",
  unloadingAugerDiameter: "",
  unloadingAugerPosition: "",
  vin: "",
};
  ...
  return (
    <form onSubmit={handleSubmit} className="mx-auto max-w-4xl rounded-2xl border border-black/10 bg-white p-6 shadow-sm md:p-8">
      ...
      <div className="mt-6 p-4 border-t border-gray-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {/* Mutate aici fuel și engineHorsepower */}
          ...
          <Input label="Axle" name="axle" value={form.axle} onChange={handleChange} />
          <Input label="Hydraulic Spout" name="hydraulicSpout" value={form.hydraulicSpout} onChange={handleChange} />
          <Input label="Monitor" name="monitor" value={form.monitor} onChange={handleChange} />
          <Input label="PTO Speed" name="PTOSpeed" value={form.PTOSpeed} onChange={handleChange} />
          <Input label="Scale" name="scale" value={form.scale} onChange={handleChange} />
          ...
          <Input label="Tarp" name="tarp" value={form.tarp} onChange={handleChange} />
          <Input label="Tires or Tracks" name="tiresOrTracks" value={form.tiresOrTracks} onChange={handleChange} />
          <Input label="Track Width" name="trackWidth" value={form.trackWidth} onChange={handleChange} />
          <Input label="Unloading Auger Diameter" name="unloadingAugerDiameter" value={form.unloadingAugerDiameter} onChange={handleChange} />
          <Input label="Unloading Auger Position" name="unloadingAugerPosition" value={form.unloadingAugerPosition} onChange={handleChange} />
