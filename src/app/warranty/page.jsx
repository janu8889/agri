  ...
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mt-5 mb-12">
        ...
        <p className="text-[#222222] text-[16px] md:text-[18px] leading-relaxed">
          From demanding construction sites to extensive agricultural projects, our machinery is proven to deliver under pressure. Our satisfied clients are our best advocates, demonstrating daily that S & W Equipment equipment stands for reliability, efficiency, and job-site excellence.
        </p>
      </div>
    </div>
